...
public class PWAItemsPoint {
	...
	private List<PWAPoint> items = null;

	@SerializedName("Links")
	private PWAPaginationLinks links = null;

	public PWAItemsPoint()  {
	}

	public void setItems(List<PWAPoint> items) { this.items = items;}

	public List<PWAPoint> getItems() { return this.items; }
