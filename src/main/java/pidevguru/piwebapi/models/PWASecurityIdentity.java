...
public class PWASecurityIdentity {
	...
	private PWASecurityIdentityLinks links = null;
	...
	public void setLinks(PWASecurityIdentityLinks links) { this.links = links;}

	public PWASecurityIdentityLinks getLinks() { return this.links; }
