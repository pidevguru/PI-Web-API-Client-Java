...
public class PWAAttributeCategory {
	...
	private PWAAttributeCategoryLinks links = null;
	...
	public void setLinks(PWAAttributeCategoryLinks links) { this.links = links;}

	public PWAAttributeCategoryLinks getLinks() { return this.links; }
