...
public class PWADataPipeEvent {
	...
	@SerializedName("PreviousEventAction")
	private String previousEventAction = null;
	...
	public void setPreviousEventAction(String previousEventAction) { this.previousEventAction = previousEventAction;}

	public String getPreviousEventAction() { return this.previousEventAction; }
