...
public class PWAExtendedTimedValue {
	...
	private List<PWAStreamAnnotation> annotations = null;
	...
	public void setAnnotations(List<PWAStreamAnnotation> annotations) { this.annotations = annotations;}

	public List<PWAStreamAnnotation> getAnnotations() { return this.annotations; }
