...
public class PWATimeRulePlugIn {
	...
	private PWATimeRulePlugInLinks links = null;
	...
	public void setLinks(PWATimeRulePlugInLinks links) { this.links = links;}

	public PWATimeRulePlugInLinks getLinks() { return this.links; }
