...
public class NotificationRuleControllerClient {
	...
	public NotificationRuleControllerClient(ApiClient apiClient){
	 ...
	 *
	 */
	public PWANotificationRule getByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWANotificationRule> resp = getByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a notification rule by path. (with HTTP information)
	 *
	 */
	public ApiResponse<PWANotificationRule> getByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getByPathCall(path, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PWANotificationRule>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PWANotificationRule> callback) throws ApiException {
	 ...
	 *
	 */
	public PWAItemsNotificationRule getNotificationRulesQuery(String databaseWebId, Integer maxCount, String query, String selectedFields, Integer startIndex, String webIdType) throws ApiException {
		ApiResponse<PWAItemsNotificationRule> resp = getNotificationRulesQueryWithHttpInfo(databaseWebId, maxCount, query, selectedFields, startIndex, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWAItemsNotificationRule> getNotificationRulesQueryWithHttpInfo(String databaseWebId, Integer maxCount, String query, String selectedFields, Integer startIndex, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getNotificationRulesQueryAsync(String databaseWebId, Integer maxCount, String query, String selectedFields, Integer startIndex, String webIdType, final ApiCallback<PWAItemsNotificationRule> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	...
	/**
	 * Delete a notification rule. (with HTTP information)
	 *
	 */
	 ...
	 *
	 */
	public PWANotificationRule get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWANotificationRule> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWANotificationRule> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PWANotificationRule> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public void update(String webId, PWANotificationRule notificationRule) throws ApiException {
		updateWithHttpInfo(webId, notificationRule);
	}

	/**
	 * Update a notification rule by replacing items in its definition. (with HTTP information)
	 *
	 */
	public ApiResponse<Void> updateWithHttpInfo(String webId, PWANotificationRule notificationRule) throws ApiException {
		okhttp3.Call call = updateCall(webId, notificationRule,null,null);
		return apiClient.execute(call);
	}
	 ...
	 *
	 */
	public okhttp3.Call updateAsync(String webId, PWANotificationRule notificationRule, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = updateCall(webId, notificationRule, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call updateCall(String webId, PWANotificationRule notificationRule, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
	 ...
	 *
	 */
	public void createNotificationRuleSubscriber(String webId, PWANotificationRuleSubscriber notificationRuleSubscriber, String webIdType) throws ApiException {
		createNotificationRuleSubscriberWithHttpInfo(webId, notificationRuleSubscriber, webIdType);
	}
	 ...
	 *
	 */
	public ApiResponse<Void> createNotificationRuleSubscriberWithHttpInfo(String webId, PWANotificationRuleSubscriber notificationRuleSubscriber, String webIdType) throws ApiException {
		okhttp3.Call call = createNotificationRuleSubscriberCall(webId, notificationRuleSubscriber, webIdType,null,null);
		return apiClient.execute(call);
	}
	 ...
	 *
	 */
	public okhttp3.Call createNotificationRuleSubscriberAsync(String webId, PWANotificationRuleSubscriber notificationRuleSubscriber, String webIdType, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = createNotificationRuleSubscriberCall(webId, notificationRuleSubscriber, webIdType, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call createNotificationRuleSubscriberCall(String webId, PWANotificationRuleSubscriber notificationRuleSubscriber, String webIdType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
	...
	/**
	 * Get the security information of the specified security item associated with the notification rule for a specified user. (with HTTP information)
	 *
	 */
	...
	/**
	 * Retrieve the security entries associated with the notification rule based on the specified criteria. By default, all security entries for this notification rule are returned. (with HTTP information)
	 *
	 */
	...
	/**
	 * Create a security entry owned by the notification rule. (with HTTP information)
	 *
	 */
	...
	/**
	 * Delete a security entry owned by the notification rule. (with HTTP information)
	 *
	 */
	...
	/**
	 * Retrieve the security entry associated with the notification rule with the specified name. (with HTTP information)
	 *
	 */
	...
	/**
	 * Update a security entry owned by the notification rule. (with HTTP information)
	 *
	 */
