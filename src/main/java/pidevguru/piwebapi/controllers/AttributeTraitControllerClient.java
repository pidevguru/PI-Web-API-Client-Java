...
public class AttributeTraitControllerClient {
	...
	public AttributeTraitControllerClient(ApiClient apiClient){
	 ...
	 *
	 */
	public PWAItemsAttributeTrait getByCategory(List<String> category, String selectedFields) throws ApiException {
		ApiResponse<PWAItemsAttributeTrait> resp = getByCategoryWithHttpInfo(category, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWAItemsAttributeTrait> getByCategoryWithHttpInfo(List<String> category, String selectedFields) throws ApiException {
		okhttp3.Call call = getByCategoryCall(category, selectedFields,null,null);
		Type localVarReturnType = new TypeToken<PWAItemsAttributeTrait>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getByCategoryAsync(List<String> category, String selectedFields, final ApiCallback<PWAItemsAttributeTrait> callback) throws ApiException {
	 ...
	 *
	 */
	public PWAAttributeTrait get(String name, String selectedFields) throws ApiException {
		ApiResponse<PWAAttributeTrait> resp = getWithHttpInfo(name, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWAAttributeTrait> getWithHttpInfo(String name, String selectedFields) throws ApiException {
		okhttp3.Call call = getCall(name, selectedFields,null,null);
		Type localVarReturnType = new TypeToken<PWAAttributeTrait>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String name, String selectedFields, final ApiCallback<PWAAttributeTrait> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
