...
public class EnumerationValueControllerClient {
	...
	public EnumerationValueControllerClient(ApiClient apiClient){
	 ...
	 *
	 */
	public PWAEnumerationValue getByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWAEnumerationValue> resp = getByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWAEnumerationValue> getByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getByPathCall(path, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PWAEnumerationValue>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PWAEnumerationValue> callback) throws ApiException {
	 ...
	 *
	 */
	public PWAEnumerationValue get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWAEnumerationValue> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWAEnumerationValue> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PWAEnumerationValue> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public void updateEnumerationValue(String webId, PWAEnumerationValue enumerationValue) throws ApiException {
	 ...
	 *
	 */
	public ApiResponse<Void> updateEnumerationValueWithHttpInfo(String webId, PWAEnumerationValue enumerationValue) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call updateEnumerationValueAsync(String webId, PWAEnumerationValue enumerationValue, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	...
	private okhttp3.Call updateEnumerationValueCall(String webId, PWAEnumerationValue enumerationValue, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
