...
public class NotificationContactTemplateControllerClient {
	...
	public NotificationContactTemplateControllerClient(ApiClient apiClient){
	 ...
	 *
	 */
	public PWANotificationContactTemplate getByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWANotificationContactTemplate> resp = getByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a notification contact template by path. (with HTTP information)
	 *
	 */
	public ApiResponse<PWANotificationContactTemplate> getByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getByPathCall(path, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PWANotificationContactTemplate>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PWANotificationContactTemplate> callback) throws ApiException {
	 ...
	 *
	 */
	public PWAItemsNotificationContactTemplate getNotificationContactTemplatesQuery(String assetServerWebId, Integer maxCount, String query, String selectedFields, Integer startIndex, String webIdType) throws ApiException {
		ApiResponse<PWAItemsNotificationContactTemplate> resp = getNotificationContactTemplatesQueryWithHttpInfo(assetServerWebId, maxCount, query, selectedFields, startIndex, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve notification contact templates based on the specified conditions. Returns notification contact templates using the specified search query string. (with HTTP information)
	 *
	 */
	public ApiResponse<PWAItemsNotificationContactTemplate> getNotificationContactTemplatesQueryWithHttpInfo(String assetServerWebId, Integer maxCount, String query, String selectedFields, Integer startIndex, String webIdType) throws ApiException {
		okhttp3.Call call = getNotificationContactTemplatesQueryCall(assetServerWebId, maxCount, query, selectedFields, startIndex, webIdType,null,null);
	 ...
	 *
	 */
	public okhttp3.Call getNotificationContactTemplatesQueryAsync(String assetServerWebId, Integer maxCount, String query, String selectedFields, Integer startIndex, String webIdType, final ApiCallback<PWAItemsNotificationContactTemplate> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = getNotificationContactTemplatesQueryCall(assetServerWebId, maxCount, query, selectedFields, startIndex, webIdType, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call getNotificationContactTemplatesQueryCall(String assetServerWebId, Integer maxCount, String query, String selectedFields, Integer startIndex, String webIdType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		...
		if (assetServerWebId != null)
			localVarQueryParams.addAll(apiClient.parameterToPairs("multi", "assetServerWebId", assetServerWebId));
		if (maxCount != null)
	...
	/**
	 * Delete a notification contact template. (with HTTP information)
	 *
	 */
	 ...
	 *
	 */
	public PWANotificationContactTemplate get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWANotificationContactTemplate> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a notification contact template. (with HTTP information)
	 *
	 */
	public ApiResponse<PWANotificationContactTemplate> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PWANotificationContactTemplate> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public void update(String webId, PWANotificationContactTemplate notificationContactTemplate) throws ApiException {
		updateWithHttpInfo(webId, notificationContactTemplate);
	}

	/**
	 * Update a notification contact template by replacing items in its definition. (with HTTP information)
	 *
	 */
	public ApiResponse<Void> updateWithHttpInfo(String webId, PWANotificationContactTemplate notificationContactTemplate) throws ApiException {
		okhttp3.Call call = updateCall(webId, notificationContactTemplate,null,null);
		return apiClient.execute(call);
	}
	 ...
	 *
	 */
	public okhttp3.Call updateAsync(String webId, PWANotificationContactTemplate notificationContactTemplate, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = updateCall(webId, notificationContactTemplate, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call updateCall(String webId, PWANotificationContactTemplate notificationContactTemplate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
	 ...
	 *
	 */
	public PWANotificationContactTemplate getNotificationContactTemplates(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWANotificationContactTemplate> resp = getNotificationContactTemplatesWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve notification contact template's child templates. (with HTTP information)
	 *
	 */
	public ApiResponse<PWANotificationContactTemplate> getNotificationContactTemplatesWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getNotificationContactTemplatesAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PWANotificationContactTemplate> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	...
	/**
	 * Get the security information of the specified security item associated with the notification contact template for a specified user. (with HTTP information)
	 *
	 */
	...
	/**
	 * Retrieve the security entries associated with the notification contact template based on the specified criteria. By default, all security entries for this notification contact template are returned. (with HTTP information)
	 *
	 */
	...
	/**
	 * Create a security entry owned by the notification contact template. (with HTTP information)
	 *
	 */
	...
	/**
	 * Delete a security entry owned by the notification contact template. (with HTTP information)
	 *
	 */
	...
	/**
	 * Retrieve the security entry associated with the notification contact template with the specified name. (with HTTP information)
	 *
	 */
	...
	/**
	 * Update a security entry owned by the notification contact template. (with HTTP information)
	 *
	 */
