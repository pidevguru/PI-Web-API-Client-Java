...
public class AttributeTemplateControllerClient {
	...
	public AttributeTemplateControllerClient(ApiClient apiClient){
	 ...
	 *
	 */
	public PWAAttributeTemplate getByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWAAttributeTemplate> resp = getByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWAAttributeTemplate> getByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getByPathCall(path, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PWAAttributeTemplate>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PWAAttributeTemplate> callback) throws ApiException {
	 ...
	 *
	 */
	public PWAAttributeTemplate get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWAAttributeTemplate> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWAAttributeTemplate> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PWAAttributeTemplate> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public void update(String webId, PWAAttributeTemplate template) throws ApiException {
	 ...
	 *
	 */
	public ApiResponse<Void> updateWithHttpInfo(String webId, PWAAttributeTemplate template) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call updateAsync(String webId, PWAAttributeTemplate template, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	...
	private okhttp3.Call updateCall(String webId, PWAAttributeTemplate template, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
	 ...
	 *
	 */
	public PWAItemsAttributeTemplate getAttributeTemplates(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWAItemsAttributeTemplate> resp = getAttributeTemplatesWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWAItemsAttributeTemplate> getAttributeTemplatesWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAttributeTemplatesAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PWAItemsAttributeTemplate> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
