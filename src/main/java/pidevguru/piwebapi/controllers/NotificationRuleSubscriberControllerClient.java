...
public class NotificationRuleSubscriberControllerClient {
	...
	public NotificationRuleSubscriberControllerClient(ApiClient apiClient){
	 ...
	 *
	 */
	public PWANotificationRuleSubscriber getByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWANotificationRuleSubscriber> resp = getByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a notification rule subscriber by path. (with HTTP information)
	 *
	 */
	public ApiResponse<PWANotificationRuleSubscriber> getByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getByPathCall(path, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PWANotificationRuleSubscriber>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PWANotificationRuleSubscriber> callback) throws ApiException {
	...
	/**
	 * Delete a notification rule subscriber. (with HTTP information)
	 *
	 */
	 ...
	 *
	 */
	public PWANotificationRuleSubscriber get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWANotificationRuleSubscriber> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a notification rule subscriber. (with HTTP information)
	 *
	 */
	public ApiResponse<PWANotificationRuleSubscriber> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PWANotificationRuleSubscriber> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public void update(String webId, PWANotificationRuleSubscriber notificationRuleSubscriber) throws ApiException {
		updateWithHttpInfo(webId, notificationRuleSubscriber);
	}

	/**
	 * Update a notification rule subscriber. (with HTTP information)
	 *
	 */
	public ApiResponse<Void> updateWithHttpInfo(String webId, PWANotificationRuleSubscriber notificationRuleSubscriber) throws ApiException {
		okhttp3.Call call = updateCall(webId, notificationRuleSubscriber,null,null);
		return apiClient.execute(call);
	}
	 ...
	 *
	 */
	public okhttp3.Call updateAsync(String webId, PWANotificationRuleSubscriber notificationRuleSubscriber, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = updateCall(webId, notificationRuleSubscriber, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call updateCall(String webId, PWANotificationRuleSubscriber notificationRuleSubscriber, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
	 ...
	 *
	 */
	public PWAItemsNotificationRuleSubscriber getNotificationRuleSubscribers(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWAItemsNotificationRuleSubscriber> resp = getNotificationRuleSubscribersWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve notification rule subscriber subscribers. (with HTTP information)
	 *
	 */
	public ApiResponse<PWAItemsNotificationRuleSubscriber> getNotificationRuleSubscribersWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getNotificationRuleSubscribersAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PWAItemsNotificationRuleSubscriber> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
