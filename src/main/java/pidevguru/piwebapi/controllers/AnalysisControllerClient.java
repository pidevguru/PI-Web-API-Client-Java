...
public class AnalysisControllerClient {
	...
	public AnalysisControllerClient(ApiClient apiClient){
	 ...
	 *
	 */
	public PWAAnalysis getByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWAAnalysis> resp = getByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWAAnalysis> getByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getByPathCall(path, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PWAAnalysis>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PWAAnalysis> callback) throws ApiException {
	 ...
	 *
	 */
	public PWAItemsAnalysis getAnalysesQuery(String databaseWebId, Integer maxCount, String query, String selectedFields, Integer startIndex, String webIdType) throws ApiException {
		ApiResponse<PWAItemsAnalysis> resp = getAnalysesQueryWithHttpInfo(databaseWebId, maxCount, query, selectedFields, startIndex, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWAItemsAnalysis> getAnalysesQueryWithHttpInfo(String databaseWebId, Integer maxCount, String query, String selectedFields, Integer startIndex, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAnalysesQueryAsync(String databaseWebId, Integer maxCount, String query, String selectedFields, Integer startIndex, String webIdType, final ApiCallback<PWAItemsAnalysis> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public PWAAnalysis get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWAAnalysis> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWAAnalysis> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PWAAnalysis> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public void update(String webId, PWAAnalysis analysis) throws ApiException {
	 ...
	 *
	 */
	public ApiResponse<Void> updateWithHttpInfo(String webId, PWAAnalysis analysis) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call updateAsync(String webId, PWAAnalysis analysis, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	...
	private okhttp3.Call updateCall(String webId, PWAAnalysis analysis, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
