...
public class ChannelControllerClient {
	...
	public ChannelControllerClient(ApiClient apiClient){
	 ...
	 *
	 */
	public PWAItemsChannelInstance instances() throws ApiException {
		ApiResponse<PWAItemsChannelInstance> resp = instancesWithHttpInfo();
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWAItemsChannelInstance> instancesWithHttpInfo() throws ApiException {
		okhttp3.Call call = instancesCall(null,null);
		Type localVarReturnType = new TypeToken<PWAItemsChannelInstance>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call instancesAsync(final ApiCallback<PWAItemsChannelInstance> callback) throws ApiException {
