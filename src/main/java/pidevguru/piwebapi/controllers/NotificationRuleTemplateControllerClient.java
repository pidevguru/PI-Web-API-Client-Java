...
public class NotificationRuleTemplateControllerClient {
	...
	public NotificationRuleTemplateControllerClient(ApiClient apiClient){
	 ...
	 *
	 */
	public PWANotificationRuleTemplate getByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWANotificationRuleTemplate> resp = getByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a notification rule template by path. (with HTTP information)
	 *
	 */
	public ApiResponse<PWANotificationRuleTemplate> getByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getByPathCall(path, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PWANotificationRuleTemplate>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PWANotificationRuleTemplate> callback) throws ApiException {
	 ...
	 *
	 */
	public PWAItemsNotificationRuleTemplate getNotificationRuleTemplatesQuery(String databaseWebId, Integer maxCount, String query, String selectedFields, Integer startIndex, String webIdType) throws ApiException {
		ApiResponse<PWAItemsNotificationRuleTemplate> resp = getNotificationRuleTemplatesQueryWithHttpInfo(databaseWebId, maxCount, query, selectedFields, startIndex, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve Notification rule templates based on the specified conditions. Returns Notification rule templates using the specified search query string. (with HTTP information)
	 *
	 */
	public ApiResponse<PWAItemsNotificationRuleTemplate> getNotificationRuleTemplatesQueryWithHttpInfo(String databaseWebId, Integer maxCount, String query, String selectedFields, Integer startIndex, String webIdType) throws ApiException {
		okhttp3.Call call = getNotificationRuleTemplatesQueryCall(databaseWebId, maxCount, query, selectedFields, startIndex, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PWAItemsNotificationRuleTemplate>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 *
	 */
	public okhttp3.Call getNotificationRuleTemplatesQueryAsync(String databaseWebId, Integer maxCount, String query, String selectedFields, Integer startIndex, String webIdType, final ApiCallback<PWAItemsNotificationRuleTemplate> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = getNotificationRuleTemplatesQueryCall(databaseWebId, maxCount, query, selectedFields, startIndex, webIdType, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call getNotificationRuleTemplatesQueryCall(String databaseWebId, Integer maxCount, String query, String selectedFields, Integer startIndex, String webIdType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
	...
	/**
	 * Delete a notification rule template. (with HTTP information)
	 *
	 */
	 ...
	 *
	 */
	public PWANotificationRuleTemplate get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWANotificationRuleTemplate> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Get the specified notification rule template. (with HTTP information)
	 *
	 */
	public ApiResponse<PWANotificationRuleTemplate> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PWANotificationRuleTemplate> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public void update(String webId, PWANotificationRuleTemplate notificationRuleTemplate) throws ApiException {
		updateWithHttpInfo(webId, notificationRuleTemplate);
	}

	/**
	 * Update a notification rule template by replacing items in its definition. (with HTTP information)
	 *
	 */
	public ApiResponse<Void> updateWithHttpInfo(String webId, PWANotificationRuleTemplate notificationRuleTemplate) throws ApiException {
		okhttp3.Call call = updateCall(webId, notificationRuleTemplate,null,null);
		return apiClient.execute(call);
	}
	 ...
	 *
	 */
	public okhttp3.Call updateAsync(String webId, PWANotificationRuleTemplate notificationRuleTemplate, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = updateCall(webId, notificationRuleTemplate, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call updateCall(String webId, PWANotificationRuleTemplate notificationRuleTemplate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
		...
		if (notificationRuleTemplate == null)
			throw new ApiException("Missing required parameter 'notificationRuleTemplate'");
		String localVarPath = "/notificationruletemplates/{webId}";
		Map<String, String> localVarHeaderParams = new HashMap<String, String>();
		Map<String, Object> localVarFormParams = new HashMap<String, Object>();
		List<Pair> localVarQueryParams = new ArrayList<Pair>();
		...
		localVarPath = localVarPath.replaceAll("\\{webId\\}", apiClient.escapeString(webId.toString()));
		localVarPostBody =  notificationRuleTemplate;
		if (progressListener != null)
		{
			apiClient.getHttpClient().networkInterceptors().add(new okhttp3.Interceptor() {
			@Override
	 ...
	 *
	 */
	public PWAItemsNotificationRuleSubscriber getNotificationRuleTemplateSubscribers(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWAItemsNotificationRuleSubscriber> resp = getNotificationRuleTemplateSubscribersWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve notification rule template subscribers. (with HTTP information)
	 *
	 */
	public ApiResponse<PWAItemsNotificationRuleSubscriber> getNotificationRuleTemplateSubscribersWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getNotificationRuleTemplateSubscribersCall(webId, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PWAItemsNotificationRuleSubscriber>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 *
	 */
	public okhttp3.Call getNotificationRuleTemplateSubscribersAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PWAItemsNotificationRuleSubscriber> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = getNotificationRuleTemplateSubscribersCall(webId, selectedFields, webIdType, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call getNotificationRuleTemplateSubscribersCall(String webId, String selectedFields, String webIdType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
	 ...
	 *
	 */
	public void createNotificationRuleTemplateSubscriber(String webId, PWANotificationRuleSubscriber notificationRuleSubscriber, String webIdType) throws ApiException {
		createNotificationRuleTemplateSubscriberWithHttpInfo(webId, notificationRuleSubscriber, webIdType);
	}

	/**
	 * Create a notification rule subscriber. (with HTTP information)
	 *
	 */
	public ApiResponse<Void> createNotificationRuleTemplateSubscriberWithHttpInfo(String webId, PWANotificationRuleSubscriber notificationRuleSubscriber, String webIdType) throws ApiException {
		okhttp3.Call call = createNotificationRuleTemplateSubscriberCall(webId, notificationRuleSubscriber, webIdType,null,null);
		return apiClient.execute(call);
	}
	 ...
	 *
	 */
	public okhttp3.Call createNotificationRuleTemplateSubscriberAsync(String webId, PWANotificationRuleSubscriber notificationRuleSubscriber, String webIdType, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = createNotificationRuleTemplateSubscriberCall(webId, notificationRuleSubscriber, webIdType, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call createNotificationRuleTemplateSubscriberCall(String webId, PWANotificationRuleSubscriber notificationRuleSubscriber, String webIdType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
		...
		if (notificationRuleSubscriber == null)
			throw new ApiException("Missing required parameter 'notificationRuleSubscriber'");
		String localVarPath = "/notificationruletemplates/{webId}/notificationrulesubscribers";
		Map<String, String> localVarHeaderParams = new HashMap<String, String>();
		Map<String, Object> localVarFormParams = new HashMap<String, Object>();
		List<Pair> localVarQueryParams = new ArrayList<Pair>();
		...
		localVarPath = localVarPath.replaceAll("\\{webId\\}", apiClient.escapeString(webId.toString()));
		localVarPostBody =  notificationRuleSubscriber;
		if (webIdType != null)
			localVarQueryParams.addAll(apiClient.parameterToPairs("multi", "webIdType", webIdType));
		if (progressListener != null)
		{
	...
	/**
	 * Get the security information of the specified security item associated with the notification rule template for a specified user. (with HTTP information)
	 *
	 */
	...
	/**
	 * Retrieve the security entries associated with the notification rule template based on the specified criteria. By default, all security entries for this notification rule template are returned. (with HTTP information)
	 *
	 */
	...
	/**
	 * Create a security entry owned by the notification rule template. (with HTTP information)
	 *
	 */
	...
	/**
	 * Delete a security entry owned by the notification rule template. (with HTTP information)
	 *
	 */
	...
	/**
	 * Retrieve the security entry associated with the notification rule template with the specified name. (with HTTP information)
	 *
	 */
	...
	/**
	 * Update a security entry owned by the notification rule template. (with HTTP information)
	 *
	 */
