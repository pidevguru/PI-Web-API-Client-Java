...
public class AnalysisRuleControllerClient {
	...
	public AnalysisRuleControllerClient(ApiClient apiClient){
	 ...
	 *
	 */
	public PWAAnalysisRule getByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWAAnalysisRule> resp = getByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWAAnalysisRule> getByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getByPathCall(path, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PWAAnalysisRule>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PWAAnalysisRule> callback) throws ApiException {
	 ...
	 *
	 */
	public PWAAnalysisRule get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWAAnalysisRule> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWAAnalysisRule> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PWAAnalysisRule> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public void update(String webId, PWAAnalysisRule analysisRule) throws ApiException {
	 ...
	 *
	 */
	public ApiResponse<Void> updateWithHttpInfo(String webId, PWAAnalysisRule analysisRule) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call updateAsync(String webId, PWAAnalysisRule analysisRule, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	...
	private okhttp3.Call updateCall(String webId, PWAAnalysisRule analysisRule, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
	 ...
	 *
	 */
	public PWAItemsAnalysisRule getAnalysisRules(String webId, Integer maxCount, String nameFilter, Boolean searchFullHierarchy, String selectedFields, String sortField, String sortOrder, Integer startIndex, String webIdType) throws ApiException {
		ApiResponse<PWAItemsAnalysisRule> resp = getAnalysisRulesWithHttpInfo(webId, maxCount, nameFilter, searchFullHierarchy, selectedFields, sortField, sortOrder, startIndex, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWAItemsAnalysisRule> getAnalysisRulesWithHttpInfo(String webId, Integer maxCount, String nameFilter, Boolean searchFullHierarchy, String selectedFields, String sortField, String sortOrder, Integer startIndex, String webIdType) throws ApiException {
		...
		Type localVarReturnType = new TypeToken<PWAItemsAnalysisRule>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 *
	 */
	public okhttp3.Call getAnalysisRulesAsync(String webId, Integer maxCount, String nameFilter, Boolean searchFullHierarchy, String selectedFields, String sortField, String sortOrder, Integer startIndex, String webIdType, final ApiCallback<PWAItemsAnalysisRule> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public void createAnalysisRule(String webId, PWAAnalysisRule analysisRule, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public ApiResponse<Void> createAnalysisRuleWithHttpInfo(String webId, PWAAnalysisRule analysisRule, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call createAnalysisRuleAsync(String webId, PWAAnalysisRule analysisRule, String webIdType, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	...
	private okhttp3.Call createAnalysisRuleCall(String webId, PWAAnalysisRule analysisRule, String webIdType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
