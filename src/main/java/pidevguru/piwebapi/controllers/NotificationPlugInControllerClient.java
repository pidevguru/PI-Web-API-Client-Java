...
public class NotificationPlugInControllerClient {
	...
	public NotificationPlugInControllerClient(ApiClient apiClient){
	 ...
	 *
	 */
	public PWANotificationPlugIn getByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWANotificationPlugIn> resp = getByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a notification plugin by path. (with HTTP information)
	 *
	 */
	public ApiResponse<PWANotificationPlugIn> getByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getByPathCall(path, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PWANotificationPlugIn>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PWANotificationPlugIn> callback) throws ApiException {
	 ...
	 *
	 */
	public PWANotificationPlugIn get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWANotificationPlugIn> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a notification plugin. (with HTTP information)
	 *
	 */
	public ApiResponse<PWANotificationPlugIn> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PWANotificationPlugIn> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
