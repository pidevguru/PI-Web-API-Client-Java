...
public class TimeRuleControllerClient {
	...
	public TimeRuleControllerClient(ApiClient apiClient){
	 ...
	 *
	 */
	public PWATimeRule getByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWATimeRule> resp = getByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWATimeRule> getByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getByPathCall(path, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PWATimeRule>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PWATimeRule> callback) throws ApiException {
	 ...
	 *
	 */
	public PWATimeRule get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PWATimeRule> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PWATimeRule> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PWATimeRule> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public void update(String webId, PWATimeRule timeRule) throws ApiException {
	 ...
	 *
	 */
	public ApiResponse<Void> updateWithHttpInfo(String webId, PWATimeRule timeRule) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call updateAsync(String webId, PWATimeRule timeRule, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	...
	private okhttp3.Call updateCall(String webId, PWATimeRule timeRule, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
